...
Products = {
			"Product_Name"   : ["Products:" , "Rice" , "Suger" , "Salt" , "Oil" , "Macaroni" , "Apple" , "Banana" , "Mango" , "Guava"],
...
while L1:
	...
	if mode == 1 :
		...
		while LC1 :
			...
			cust_choise = int(input("Enter Your Choise: "))
			print("-"*30)
			os.system("cls")
		...
		while checking != 3 :
			...
			if password == 1996 :
				...
				while LO1 :
					...
					print("-"*30)
					own_choise = int(input("Enter Your Choise: "))
					print("-"*30)
					...
					if own_choise == 1 :
						...
						while LO :
							...
							New_Ch = input("Enter Your Choise: ")
							print("-"*30)
						...
						while L_Change :
							...
							print("-"*30)
							print("Do You Want To Chnage Price Of Another Element ? ---> Y - N")
							Ch_Check = input("Enter Your Choise: ")
							os.system("cls")
